...
import { type IStatisticsService, type IStatisticsController } from '@/src/core/interfaces'
import { TOKENS } from '@/src/infrastructure/di/tokens'

@injectable()
export class StatisticsController implements IStatisticsController {
  constructor(@inject(TOKENS.StatisticsService) private statisticsService: IStatisticsService) {}
